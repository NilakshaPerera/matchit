            ...
            <div class="col-md-12 card">
                ...
                <div class="entry-content">
                    ...
                    <p>We use your data to provide and improve the Service. By using the Service, you agree to the
                        ...
                        Conditions, accessible from {{ url('') }}</p>
                    ...
                    <p>If you are located outside Sri Lanka and choose to provide information to us, please note that we
                        transfer the data, including Personal Data, to Sri Lanka and process it there.</p>
                    ...
                    <p>Matchit will take all steps reasonably necessary to ensure that your data is treated securely and in
                    ...
                    <p>Matchit may disclose your Personal Data in the good faith belief that such action is necessary to:
                    </p>
                    <ul>
